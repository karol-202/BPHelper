                           ...
                           private val recordingDataStore: RecordingDataStore) : RecordingService
{
	...
	override fun start(recordingName: String)
	{
		...
		val recordingRequest = NewRecordingModel(recordingName, recordingController.recordingExtension)
	...
	override fun isNameAvailable(name: String) =
		recordingDataStore.isNameAvailable(name, recordingController.recordingExtension)
