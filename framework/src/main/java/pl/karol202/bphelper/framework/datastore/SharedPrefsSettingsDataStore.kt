...
import pl.karol202.bphelper.framework.sharedprefs.FlowSharedPrefsDataStore

private const val SETTINGS_KEY = "settings"

class SharedPrefsSettingsDataStore(preferences: FlowSharedPreferences) : SettingsDataStore
{
	private val delegate = FlowSharedPrefsDataStore(preferences, SettingsEntity.serializer(), SETTINGS_KEY)
